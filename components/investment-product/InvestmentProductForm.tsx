                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                readOnly
                                className="w-full px-5 py-4 bg-muted-bg/30 border border-border-divider rounded-2xl font-mono text-text-primary opacity-60 uppercase"
                            />
                        </div>
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-5 py-4 bg-muted-bg/30 border border-border-divider rounded-2xl focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500/50 outline-none text-text-primary transition-all uppercase"
                            />
                        </div>
                        <div>
